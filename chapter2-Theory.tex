...
\section{Perturbative QCD and Resummation}
	...
	\subsection{Resumming Higher-Order Corrections}
		...
		of the expansion as being controlled by only the strong coupling constant, $\alpha_s$.  A fair criticism at this argument is that
	...
	% \subsection{Parton showers for Monte-Carlo generators}

	% 	{\color{red}
	% 	\begin{itemize}
	% 		\item Should probably say a little about parton showers since most of the MC vs. data plots are showered,
	% 		\item Could also say a bit about ARIADNE since we match to it and it justifies the ATLAS pure jets chapter to some extent...
	% 	\end{itemize}
	% 	}
