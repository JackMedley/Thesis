...
\section{Divergences and Regularisation}
	...
	\subsection{Ultraviolet divergences}
		...
		where the integral is understood to run over all four momentum components form zero up to infinity
		and $m$ is some finite mass. In the UV region where $k\rightarrow\infty$ this is asymptotically equal
		to:
...
\section{QCD Factorisation at Hadronic Colliders}
	...
	So far we have only talked about the very general idea of two particles interacting and scattering off one another in to
